...
*/
    ...
    */
    ...
    // CALCULO DESVIACION ESTANDAR DE ELEMENTOS POR FILA

    

    test_solve_L_analysis_multirow(pch, csrRowPtrL_tmp, csrColIdxL_tmp, csrValL_tmp, n);
//    test_cusparse(pch, csrRowPtrL_tmp, csrColIdxL_tmp, csrValL_tmp, n);


    // test_two_streams( pch, csrRowPtrL_tmp, csrColIdxL_tmp, csrValL_tmp, n);
