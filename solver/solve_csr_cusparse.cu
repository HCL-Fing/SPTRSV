...
/*    DEPRECATED
void csr_L_solve_cusparse ( sp_mat_t * mat, const VALUE_TYPE * d_b, VALUE_TYPE * d_x, int n,
                            cusparseHandle_t cusp_handle, cusparseMatDescr_t desc_L, cusparseSolveAnalysisInfo_t info_L ){
    ...
    #ifdef __float__
                        DEPRECATED
        CUSP_CHK( cusparseScsrsv_solve( cusp_handle , CUSPARSE_OPERATION_NON_TRANSPOSE, n,
                                        &alpha, desc_L,
                                        mat->a, mat->ia, mat->ja, info_L,
                                        d_b, d_x ) )
    #else
                    DEPRECATED
        CUSP_CHK( cusparseDcsrsv_solve( cusp_handle , CUSPARSE_OPERATION_NON_TRANSPOSE, n,
                                        &alpha, desc_L,
                                        mat->a, mat->ia, mat->ja, info_L,
                                        d_b, d_x ) )
    #endif
