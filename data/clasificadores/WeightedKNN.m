function [trainedClassifier, validationAccuracy] = WeightedKNN(datasetTable)
...
% Train a classifier
trainedClassifier = fitcknn(predictors, response, 'PredictorNames', {'column_1' 'column_2' 'column_3' 'column_4' 'column_5' 'column_7'}, 'ResponseName', 'column_10', 'ClassNames', [1 2 3 4 5], 'Distance', 'Euclidean', 'Exponent', '', 'NumNeighbors', 10, 'DistanceWeight', 'SquaredInverse', 'StandardizeData', 1);
